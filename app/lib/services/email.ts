...
export async function sendAdminInvestmentNotification(data: InvestmentEmailData) {
  try {
    ...
    // Template HTML para administradores
...
<html lang="es">
  <head>
    ...
    <style media="all" type="text/css">
    /* Usar los mismos estilos del template principal */
    body {
      font-family: Helvetica, sans-serif;
      -webkit-font-smoothing: antialiased;
      font-size: 16px;
  ...
  <body>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              <tr>
                <td class="wrapper">
                  ...
                  <p style="background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 4px; padding: 12px; color: #856404;"><strong>📞 Recordatorio:</strong> Contactar al usuario dentro de las próximas 24-48 horas para coordinar el proceso de pago.</p>
                </td>
              </tr>
            </table>
            ...
            <div class="footer">
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link"><strong>Agrobeat | Inviertiendo en el futuro de la agricultura</strong></span>
                    <br>Notificación automática del sistema.
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
    ...
    const result = await resend.emails.send({
      from: fromEmail,
      to: adminEmails,
      subject: `🚨 Nueva Inversión: ${plantCount} plantas - ${campaignTitle}`,
      html: adminEmailHtml,
      text: `Nueva inversión registrada:
